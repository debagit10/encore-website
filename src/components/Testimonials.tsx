...
const testimonials = [
  {
    message:
      "I am so glad I came across Encore at the time I did. It made preparing for my Unified AI Directory less stressful, and I could study more effectively and make contents with ease.",
    name: "Tope Wilson",
  ...
  {
    message:
      "I love the way i can come on here and get to the assurance that any AI i need for anything i want to do, i get it easily and with just a few clicks. This is a great platform to get to other resources and to make life easier for me. I use for mostly my content making and editing of videos.",
  ...
  {
    message:
      "My experience writing exams has always been terrible. After getting the right artificial intelligence that would help me with the exams preparations , it was amazing. I totally recommend this platform to anyone that needs an AI assistant",
